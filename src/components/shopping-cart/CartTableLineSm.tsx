...
const CartTableLineSm: FC<T_Props> = ({ item, update, i }) => {
   ...
   return (
      <>
         <tr>
            <td>
               <span className="h6">Product {i + 1}:</span>
            </td>
         </tr>
         <tr>
            <td>
            ...
            <td>
               ...
               <ul style={{ listStyle: "none", marginLeft: "-20px" }}>
                  {item.variationOptions.map(
                     (opt: T_ProductVariationOption) => (
                        <li key={opt.value}>
...
export default CartTableLineSm;
